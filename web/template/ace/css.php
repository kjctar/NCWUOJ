...
?>
	<link rel="stylesheet" href="<?php echo $path_fix."template/$OJ_TEMPLATE/"?>css/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" type="text/css" href="<?php echo $path_fix."template/$OJ_TEMPLATE/"?>css/default.css">
	<link rel="stylesheet" href="<?php echo $path_fix."template/$OJ_TEMPLATE/"?>css/style.css"> <!-- Resource style -->
