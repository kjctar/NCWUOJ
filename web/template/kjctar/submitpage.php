...
layui.use('layer', function(){ //独立版的layer无需执行这一句
  ...
  //触发事件
                ...
                ,shade: false
                ,offset: '20px'
                ,content: '<center><br><br>&nbsp;&nbsp;输入数据<br>&nbsp;&nbsp;&nbsp;<textarea cols=40 rows=5 id="input_text" name="input_text" ></textarea><hr>&nbsp;&nbsp;输出数据<br>&nbsp;&nbsp;<textarea cols=40 rows=5 id="out" name="out" >SHOULD BE:</textarea><br><br>&nbsp;&nbsp;<input id="TestRun" class="btn btn-info" type=button value="<?php echo $MSG_TR?>" onclick=do_test_run();><span class="btn" id=result>状态</span></center>'
                ,anim: 2
            ...
            //             alert(msg);
                         if(msg<1000)
                         {
                         	msg=hint[msg];
                              ...
                              //spop('<table id="result" class="table"><tr><td>测试点<td> 时间<td>内存 <td>结果 </tr></table>');
                           ...
                           // document.getElementById("result").innerHTML+="<tr><td>"+result[i].filename+"<td>"+result[i].time+"<td>"+result[i].memory+"<td>"+result[i].result+"</tr>";
                                                                        }
                                                                     }
                                                          }
                                                       }); 
