...
<html lang="en">
  ...
  <body>
    ...
    <?php include("template/$OJ_TEMPLATE/nav.php");?>	    
      ...
      <script src="template/kjctar/highlight/highlight.pack.js"></script>
      <link rel="stylesheet" type="text/css" href="template/kjctar/highlight/styles/atom-one-dark.css"/>
      <script>hljs.initHighlightingOnLoad();</script>
<!--	
<link href='highlight/styles/shThemeRDark.css' rel='stylesheet' type='text/css'/>
...
echo '<pre style="padding:0px 0px;"><code class="'.$brush.'"">';
ob_start();
echo "/**************************************************************\n";
