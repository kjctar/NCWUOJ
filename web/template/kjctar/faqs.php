...
<div class="layui-card">
  <div class="layui-card-body">
   <i style='color:gray;font-size:20px;'><?php echo $OJ_NAME?>  FAQ</i>
  </div>
</div>
<div class="layui-card">
  <div class="layui-card-header"><font color=green>Q</font>:What is the compiler the judge is using and what are the compiler options?</div>
  <div class="layui-card-body">
...
<div class="layui-card">
  <div class="layui-card-header"><font color=green>Q</font>:Where is the input and the output?</div>
  <div class="layui-card-body">
...
<div class="layui-card">
  <div class="layui-card-header"><font color=green>Q</font>:Why did I get a Compile Error? It's well done!</div>
  <div class="layui-card-body">
...
<div class="layui-card">
  <div class="layui-card-header"><font color=green>Q</font>:What is the meaning of the judge's reply XXXXX?</div>
  <div class="layui-card-body">
...
<div class="layui-card">
  <div class="layui-card-header"><font color=green>Q</font>:How to attend Online Contests?</div>
  <div class="layui-card-body">
