...
<body class="main_body">
	<div class="layui-layout layui-layout-admin" style='background-color:#eeeeee'>
						...
						<?php 
							if(isset($sid))
							{
								...
								<dl class="layui-nav-child">
									...
									<dd><a href="modifypage.php" target="main"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"><cite>修改密码</cite></i></a></dd>
		...
		<!-- 右侧内容 -->
		<div  class='layui-body'     style='background-color: #FBFBFB;
								            background-image:url("template/kjctar/images/load2.gif");
            ...
            position:absolute;left:10px;bottom: 10px;top:10px; width:98%;height:98%;position: relative;z-index: 9999' src="index.php?main=1"></iframe>
		</div>
		<!-- 底部 --><!--
