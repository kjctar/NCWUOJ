...
echo "<input id='search1' onclick='search()' type='button' class='form-control' value='$MSG_SEARCH'></form>";
?>
</div>
<div id=center style="overflow: auto"  >
<table id=result-tab class="layui-table" lay-size="sm"    align=center>
<thead>
<tr >
...
<div id=center>
<?php echo "<button class='layui-btn layui-btn-sm  layui-btn-primary'   onclick=javascript:skippage('status.php?".$str2."');>顶页</button>&nbsp;&nbsp;";
if (isset($_GET['prevtop']))
echo "<button  class='layui-btn layui-btn-sm  layui-btn-primary'  onclick=javascript:skippage('status.php?".$str2."&top=".intval($_GET['prevtop'])."');>前一页</button>&nbsp;&nbsp;";
else
echo "<button class='layui-btn layui-btn-sm  layui-btn-primary'  onclick=javascript:skippage('status.php?".$str2."&top=".($top+20)."');>前一页</button>&nbsp;&nbsp;";
echo "<button class='layui-btn layui-btn-sm  layui-btn-primary'  onclick=javascript:skippage('status.php?".$str2."&top=".$bottom."&prevtop=$top');>下一页</button>";
?>
</div>
      </div>
